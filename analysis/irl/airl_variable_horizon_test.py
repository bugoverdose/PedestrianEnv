...
def train_AIRL(
    ...
    trainer = airl.AIRL(
        demonstrations=load_traj(subjId = subjId, fixed_horizon=False),
        demo_batch_size=256,
...
# Terrible results on `use_fixed_episodes=False`
if __name__ == "__main__":
    ...
    train_AIRL(
        ...
        reward_net_activation=nn.Tanh,
        use_fixed_episodes=True,
        sub_dir="variable_horizon_3_256_3_1_disc_lr1e-3_disc_wd1e-4_T/",
    )
    ...
    #     sub_dir="variable_horizon_3_256_3_1_disc_lr1e-3_disc_wd1e-4_F/",
    # )
